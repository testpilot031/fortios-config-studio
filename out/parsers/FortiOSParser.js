...
class FortiOSParser {
    ...
    buildFullPath(stack, currentName) {
        const pathParts = stack.map(block => block.name);
        pathParts.push(currentName);
        return pathParts.join(' > ');
    }
    getConfigSections(blocks) {
        const sections = new Set();
        const collectSections = (blocks) => {
    ...
    getBlocksBySection(blocks, section) {
        const result = [];
...
exports.FortiOSParser = FortiOSParser;
//# sourceMappingURL=FortiOSParser.js.map