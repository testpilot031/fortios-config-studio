...
exports.ShowSummaryCommand = void 0;
...
class ShowSummaryCommand {
    ...
    static createOrShow(extensionUri, document) {
        ...
        const panel = vscode.window.createWebviewPanel('fortiOSSummary', 'FortiOS Configuration Summary', column || vscode.ViewColumn.One, {
            enableScripts: true,
    ...
    static updateContent(document) {
        if (!ShowSummaryCommand.currentPanel) {
            return;
        }
        const analyzer = new ConfigAnalyzer_1.ConfigAnalyzer();
    ...
    static getWebviewContent(summary, summaryText) {
        return `<!DOCTYPE html>
        <html lang="en">
        <head>
            <meta charset="UTF-8">
            ...
            <div class="summary-grid">
                ...
                <div class="summary-item">
                    ...
                    <div class="interface-list">
                        ${summary.interfaces.configured.map((iface) => `<span>${iface}</span>`).join(', ')}
                    </div>
                </div>
