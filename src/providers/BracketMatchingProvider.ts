...
export class FortiOSBracketMatchingProvider implements vscode.DocumentHighlightProvider {
        ...
        if (word === 'config') {
            ...
            if (matchingEnd !== -1) {
                ...
                const endRange = new vscode.Range(
                    matchingEnd,
                    endLine.text.indexOf('end'),
                    matchingEnd,
                    endLine.text.indexOf('end') + 3
                );
            ...
            if (matchingConfig !== -1) {
                ...
                const configRange = new vscode.Range(
                    matchingConfig,
                    configLine.text.indexOf('config'),
                    matchingConfig,
                    configLine.text.indexOf('config') + 6
                );
            ...
            if (matchingNext !== -1) {
                ...
                const nextRange = new vscode.Range(
                    matchingNext,
                    nextLine.text.indexOf('next'),
                    matchingNext,
                    nextLine.text.indexOf('next') + 4
                );
            ...
            if (matchingEdit !== -1) {
                ...
                const editRange = new vscode.Range(
                    matchingEdit,
                    editLine.text.indexOf('edit'),
                    matchingEdit,
                    editLine.text.indexOf('edit') + 4
                );
    ...
    private findMatchingEnd(document: vscode.TextDocument, startLine: number, startKeyword: string, endKeyword: string): number {
        let depth = 0;
    ...
    private findMatchingStart(document: vscode.TextDocument, endLine: number, endKeyword: string, startKeyword: string): number {
        let depth = 0;
